...
app.listen(port, () => {
  ...
  addPost("The Ups and Downs of a Learning Process", "I think one of the aspects I love most about taking on small coding projects like the creation of this blog site is the learning process. This website was a practice in using EJS and creating appropriate paths across the site for the backend portion. It took some time to figure out the correct way to send the required information to where it needs to go. For the frontend portion, the design at first went awry before I sat down and created a mockup of the desired visuals which helped tremendously. There were many moments of being stumped which were discouraging but moving through them and figuring things out also brought about a feeling of accomplishment. Solving any problem always comes with a lesson (if you do it right) that can help you hone your skills. I think it is very important to learn to enjoy this process as you move through the journey of learning – it will definitely make things a little easier.");
});